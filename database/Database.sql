...
(94, 9, "Durante el último mes, ¿cuántas veces ha tenido problemas para dormir a causa de no poder conciliar el sueño en la primera media hora?"),
(95, 9, "Durante el último mes, ¿cuántas veces ha tenido problemas para dormir a causa de despertarse durante la noche o de madrugada?"),
(96, 9, "Durante el último mes, ¿cuántas veces ha tenido problemas para dormir a causa de tener que levantarse para ir al sanitario?"),
(97, 9, "Durante el último mes, ¿cuántas veces ha tenido problemas para dormir a causa de no poder respirar bien?"),
(98, 9, "Durante el último mes, ¿cuántas veces ha tenido problemas para dormir a causa de toser o roncar ruidosamente?"),
(99, 9, "Durante el último mes, ¿cuántas veces ha tenido problemas para dormir a causa de sentir frío?"),
(100, 9, "Durante el último mes, ¿cuántas veces ha tenido problemas para dormir a causa de sentir demasiado calor?"),
(101, 9, "Durante el último mes, ¿cuántas veces ha tenido problemas para dormir a causa de tener pesadillas o “malos sueños”?"),
(102, 9, "Durante el último mes, ¿cuántas veces ha tenido problemas para dormir a causa de sufrir dolores?"),
(103, 9, "Durante el último mes, ¿cuántas veces ha tenido problemas para dormir a causa de otras razones?"),
(104, 9, "Durante el último mes ¿cómo valoraría, en conjunto, la calidad de su dormir?"),
(105, 9, "Durante el último mes, ¿cuántas veces habrá tomado medicinas (por su cuenta o recetadas por el médico) para dormir?"),
(106, 9, "Durante el último mes, ¿cuántas veces ha sentido somnolencia mientras conducía, comía o desarrollaba alguna otra actividad?"),
(107, 9, "Durante el último mes, ¿ha representado para usted mucho problema el “tener ánimos” para realizar alguna de las actividades detalladas en la pregunta anterior?");

-- Insertar las preguntas para el de autocompasion
INSERT INTO Preguntas(ID_Pregunta, ID_TipoFormulario, Texto) VALUES
(108, 10, 'Me desapruebo y me juzgo por mis defectos y limitaciones.'),
(109, 10, 'Cuando me siento desanimado tiendo a obsesionarme y fijarme en todo lo que está mal.'),
(110, 10, 'Cuando las cosas van mal para mí, veo las dificultades como una parte de la vida por la que todos pasan.'),
(111, 10, 'Cuando pienso en mis limitaciones tiendo a sentirme más separado y aislado del resto del mundo.'),
(112, 10, 'Intento ser cariñoso/a conmigo mismo/a cuando siento dolor emocional.'),
(113, 10, 'Cuando fallo en algo importante para mí, me consumen los sentimientos de insuficiencia.'),
(114, 10, 'Cuando me siento desanimado y triste, me recuerdo a mí mismo que hay muchas otras personas en el mundo que se sienten como yo.'),
(115, 10, 'Cuando atravieso épocas muy difíciles, tiendo a ser duro/a conmigo mismo/a.'),
(116, 10, 'Cuando algo me molesta, trato de mantener mis emociones en equilibrio.'),
(117, 10, 'Cuando me siento incapaz de alguna manera, trato de recordarme que esos sentimientos de incapacidad son compartidos por la mayoría de las personas.'),
(118, 10, 'Soy intolerante e impaciente con aquellos aspectos de mi personalidad que no me gustan.'),
(119, 10, 'Cuando atravieso una situación muy difícil, yo mismo/a me proporciono el cuidado y cariño que necesito.'),
(120, 10, 'Cuando me siento desanimado/a, tiendo a sentir que probablemente la mayoría de las personas son más felices que yo.'),
(121, 10, 'Cuando sucede algo doloroso, trato de tener una visión equilibrada de la situación.'),
(122, 10, 'Intento ver mis fallas como parte de la condición humana.'),
(123, 10, 'Cuando veo aspectos de mí mismo/a que no me gustan, me deprimo.'),
(124, 10, 'Cuando me equivoco en algo importante para mí, trato de ver las cosas con perspectiva.'),
(125, 10, 'Cuando realmente estoy en problemas, tiendo a sentir que a otras personas les debe resultar más fácil.'),
(126, 10, 'Soy amable conmigo mismo/a cuando estoy experimentando sufrimiento.'),
(127, 10, 'Cuando algo me molesta me dejo llevar por mis sentimientos.'),
(128, 10, 'Puedo ser un poco insensible hacia mí mismo/a cuando experimento sufrimiento.'),
(129, 10, 'Cuando me siento deprimido/a trato de observar mis sentimientos con curiosidad y mente abierta.'),
(130, 10, 'Soy intolerante con mis propios defectos y limitaciones.'),
(131, 10, 'Cuando sucede algo doloroso tiendo a exagerar la gravedad del incidente.'),
(132, 10, 'Cuando fallo en algo que es importante para mí, tiendo a sentirme solo en mi fracaso.'),
(133, 10, 'Intento ser comprensivo y paciente con aquellos aspectos de mi personalidad que no me gustan.');
